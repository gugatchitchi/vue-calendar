        ...
        <v-card>
          <v-container>
            <v-form @submit.prevent="addEvent">
              ...
              <v-text-field v-model="color" type="color" label="color (click open color menu)"></v-text-field>
        ...
        >
          ...
          >
            ...
            <v-card-actions>
              ...
              <v-btn text v-else @click.prevent="saveEvent(selectedEvent)"> Save </v-btn>
            </v-card-actions>
          </v-card>
        </v-menu>
      </v-sheet>
